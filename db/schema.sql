...
CREATE TABLE IF NOT EXISTS payment_orders (
  ...
  site_b_id BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'B站ID，下单时快照',
  site_b VARCHAR(191) NOT NULL DEFAULT '' COMMENT 'B站域名，下单时快照',
  ...
  notify_verify TEXT NULL COMMENT 'Shopyy异步verify快照JSON',
...
CREATE TABLE IF NOT EXISTS channel_accounts (
  ...
  site_b_id BIGINT UNSIGNED NOT NULL COMMENT 'B站ID',
  account_no VARCHAR(128) NOT NULL COMMENT '账号名称',
  alias VARCHAR(128) NOT NULL DEFAULT '' COMMENT '别名',
  status INT NOT NULL DEFAULT 1 COMMENT '状态 1启用 0禁用',
  reset_hour INT NOT NULL DEFAULT 0 COMMENT '重置小时',
  reset_timezone VARCHAR(32) NOT NULL DEFAULT '北京重置时间' COMMENT '重置时区',
  daily_order_limit INT NOT NULL DEFAULT 0 COMMENT '日限单数',
  daily_amount_limit DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '日限金额USD',
  daily_recv_count INT NOT NULL DEFAULT 0 COMMENT '日收笔数',
  daily_recv_amount DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '日收金额USD',
  intercept_mode VARCHAR(16) NOT NULL DEFAULT 'reset' COMMENT '拦截模式',
  intercept_currency VARCHAR(16) NOT NULL DEFAULT 'USD' COMMENT '拦截货币',
  intercept_max DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '拦截最大金额',
  intercept_min DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '拦截最小金额',
  amount_limit_mode VARCHAR(16) NOT NULL DEFAULT 'reset' COMMENT '金额限制模式',
  calc_currency VARCHAR(16) NOT NULL DEFAULT 'USD' COMMENT '计算货币',
  currencies JSON NOT NULL COMMENT '支付货币',
  allow_countries JSON NOT NULL COMMENT '仅支持国家',
  prefer_countries JSON NOT NULL COMMENT '优先国家',
  ...
  disable_card_brands JSON NOT NULL COMMENT '禁用卡头',
  pay_frequency INT NOT NULL DEFAULT 0 COMMENT '支付频率天',
  success_count_limit INT NOT NULL DEFAULT 0 COMMENT '指定时间内限制成功次数',
  max_success_count INT NOT NULL DEFAULT 0 COMMENT '最多收款笔数',
  sort INT NOT NULL DEFAULT 0 COMMENT '排序',
  app_id VARCHAR(512) NOT NULL DEFAULT '' COMMENT '应用ID',
  public_key VARCHAR(512) NOT NULL DEFAULT '' COMMENT '公钥',
  merchant_id VARCHAR(128) NOT NULL DEFAULT '' COMMENT '商户ID',
  web_secret VARCHAR(512) NOT NULL DEFAULT '' COMMENT 'web秘钥',
  ...
  assigned_user_id BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '分配子账号用户ID，0表示未分配',
  total_received DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '总收款USD',
  unpaid_closed TINYINT(1) NOT NULL DEFAULT 0 COMMENT '跳转未付关闭',
  restricted_closed TINYINT(1) NOT NULL DEFAULT 0 COMMENT '账号受限关闭',
  cannot_open_at8 TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'B站打不开',
  remark VARCHAR(512) NOT NULL DEFAULT '' COMMENT '备注',
  created_by VARCHAR(64) NOT NULL DEFAULT '' COMMENT '创建人',
  updated_by VARCHAR(64) NOT NULL DEFAULT '' COMMENT '更新人',
  created_at DATETIME NULL COMMENT '创建时间',
  updated_at DATETIME NULL COMMENT '更新时间',
  PRIMARY KEY (id),
  UNIQUE KEY idx_channel_accounts_channel_site_b (channel_id, site_b_id),
  KEY idx_channel_accounts_channel_id (channel_id),
  KEY idx_channel_accounts_site_b_id (site_b_id),
  KEY idx_channel_accounts_status (status),
  KEY idx_channel_accounts_assigned_user_id (assigned_user_id)
...
CREATE TABLE IF NOT EXISTS channel_groups (
  ...
  code VARCHAR(64) NOT NULL COMMENT '分组CODE',
  name VARCHAR(64) NOT NULL COMMENT '分组名称',
  total_amount DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '累计收款USD',
  balance DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '余额USD',
  daily_order_limit INT NOT NULL DEFAULT 0 COMMENT '日限单数',
  daily_amount_limit DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '日限金额USD',
  daily_recv_count INT NOT NULL DEFAULT 0 COMMENT '日收笔数',
  daily_recv_amount DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '日收金额USD',
  ...
  fail_count INT NOT NULL DEFAULT 0 COMMENT '失败次数限制',
  success_count INT NOT NULL DEFAULT 0 COMMENT '成功次数限制',
  amount_limit_mode VARCHAR(16) NOT NULL DEFAULT 'reset' COMMENT '金额限制模式 reset重置 intercept拦截',
  calc_currency VARCHAR(16) NOT NULL DEFAULT 'USD' COMMENT '计算货币',
  intercept_max DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '拦截最大金额',
  intercept_min DECIMAL(18,2) NOT NULL DEFAULT 0 COMMENT '拦截最小金额',
  old_customer_days INT NOT NULL DEFAULT 30 COMMENT '老客户判断天数',
  ...
  updated_at DATETIME NULL COMMENT '更新时间',
  PRIMARY KEY (id),
  UNIQUE KEY idx_channel_groups_code (code),
